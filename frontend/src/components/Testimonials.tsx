...
function TestimonialCard({ testimonial, index }: { testimonial: typeof testimonials[0]; index: number }) {
  ...
  return (
    <div
      ref={ref}
      className={`bg-white rounded-2xl p-6 md:p-7 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-500 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
    ...
    >
      ...
      <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-4">"{testimonial.text}"</p>
  ...
  return (
    <section className="bg-gradient-to-b from-white to-gray-50 py-10 md:py-14">
      <div className="max-w-[1440px] mx-auto p-[5%]">
        ...
        {/* Trust Bar */}
        <div className="mt-10 md:mt-12 bg-white rounded-2xl border border-gray-100 p-6 md:p-8 lg:p-10 shadow-sm">
